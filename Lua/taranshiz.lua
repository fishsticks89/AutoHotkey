...
-- Through, I have since abandoned luamacros, in favor of Interception... which i will abandon in favor of QMK.
...
local keyboardIdentifier = 'PID_2106'
...
if keyboardIdentifier == 'AAA0000' then
...
sendToAHK = function (key)
      ...
      local file = io.open("C:\\Users\\ebarr_2y3vyla\\Desktop\\AutoHotkey\\Lua\\keypressed.txt", "w") -- writing this string to a text file on disk is probably NOT the best method. Feel free to program something better!
